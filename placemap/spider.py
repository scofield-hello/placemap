                ...
                for pattern in matches:
                    ...
                    for page_num in range(1, page_size + 1):
                        ...
                        for p_el in p_el_list:
                            position = __parse_position(country_name, p_el)
...
def __parse_position(country_name: str, p_el: WebElement) -> Position:
    ...
    return (country_name, title, address, latitude, longitude, phone, web)
...
def __process_position(workbook: Workbook) -> None:
    ...
    __close_xls(workbook, "./四国政府机构数据.xlsx")
